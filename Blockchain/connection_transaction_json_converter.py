...
class JSONConnectionTransactionConverter:
    ...
    def __init__(self, transaction_info: dict):
        ...
        signature = Signature(signature_string=transaction_info['signature'])
        ...
        self._transaction = ConnectionTransaction(user_public_key, time, user_ip, user_port, connection_status, 
